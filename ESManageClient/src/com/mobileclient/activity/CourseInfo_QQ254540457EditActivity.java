			...
			public void onClick(View v) {
				try {
					...
					if(ET_courseName.getText().toString().equals("")) {
						Toast.makeText(CourseInfo_QQ254540457EditActivity.this, "课程名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_courseTime.getText().toString().equals("")) {
						Toast.makeText(CourseInfo_QQ254540457EditActivity.this, "上课时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_coursePlace.getText().toString().equals("")) {
						Toast.makeText(CourseInfo_QQ254540457EditActivity.this, "上课地点输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_courseScore.getText().toString().equals("")) {
						Toast.makeText(CourseInfo_QQ254540457EditActivity.this, "课程学分输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_courseMemo.getText().toString().equals("")) {
						Toast.makeText(CourseInfo_QQ254540457EditActivity.this, "附加信息输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传课程信息信息*/
					CourseInfo_QQ254540457EditActivity.this.setTitle("正在更新课程信息信息，稍等...");
