	...
	public void onCreate(Bundle savedInstanceState) {
		...
		spinner_studentNumber.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionStudentSelectCourseInfo.setStudentNumber(student_QQ287307421List.get(arg2-1).getStudentNumber()); 
				else
		...
		spinner_courseNumber.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionStudentSelectCourseInfo.setCourseNumber(courseInfo_QQ254540457List.get(arg2-1).getCourseNumber()); 
				else
		...
		btnQuery.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					...
					intent.setClass(StudentSelectCourseInfoQueryActivity.this, StudentSelectCourseInfoListActivity.class);
					Bundle bundle = new Bundle();
					bundle.putSerializable("queryConditionStudentSelectCourseInfo", queryConditionStudentSelectCourseInfo);
					intent.putExtras(bundle);
					startActivity(intent);  
					StudentSelectCourseInfoQueryActivity.this.finish();
				} catch (Exception e) {}
			}
			});
	}
