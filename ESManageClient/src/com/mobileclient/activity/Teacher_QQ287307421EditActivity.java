			...
			public void onClick(View v) {
				try {
					...
					if(ET_teacherName.getText().toString().equals("")) {
						Toast.makeText(Teacher_QQ287307421EditActivity.this, "教师姓名输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_teacherPassword.getText().toString().equals("")) {
						Toast.makeText(Teacher_QQ287307421EditActivity.this, "登录密码输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_teacherSex.getText().toString().equals("")) {
						Toast.makeText(Teacher_QQ287307421EditActivity.this, "性别输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_teacherCardNumber.getText().toString().equals("")) {
						Toast.makeText(Teacher_QQ287307421EditActivity.this, "身份证号输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_teacherPhone.getText().toString().equals("")) {
						Toast.makeText(Teacher_QQ287307421EditActivity.this, "联系电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if (!teacher_QQ287307421.getTeacherPhoto().startsWith("upload/")) {
						...
						Teacher_QQ287307421EditActivity.this.setTitle("正在上传图片，稍等...");
						String teacherPhoto = HttpUtil.uploadFile(teacher_QQ287307421.getTeacherPhoto());
						Teacher_QQ287307421EditActivity.this.setTitle("图片上传完毕！");
						teacher_QQ287307421.setTeacherPhoto(teacherPhoto);
					} 
					/*验证获取家庭地址*/ 
					if(ET_teacherAddress.getText().toString().equals("")) {
						Toast.makeText(Teacher_QQ287307421EditActivity.this, "家庭地址输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_teacherMemo.getText().toString().equals("")) {
						Toast.makeText(Teacher_QQ287307421EditActivity.this, "附加信息输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传教师信息信息*/
					Teacher_QQ287307421EditActivity.this.setTitle("正在更新教师信息信息，稍等...");
